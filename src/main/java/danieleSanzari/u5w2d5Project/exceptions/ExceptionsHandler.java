...
import danieleSanzari.u5w2d5Project.payloads.ErrorsDTO;
import danieleSanzari.u5w2d5Project.payloads.ErrorsWithListDTO;
...
public class ExceptionsHandler {
    ...
    public ErrorsDTO handleGeneric(Exception ex) {
        ex.printStackTrace();
        return new ErrorsDTO(
                "C'è stato un errore generico! Stiamo lavorando per risolverlo!",
                LocalDateTime.now()
        );
    }
}
